        ...
        <form action="AdminController?type=AdminmemInfo" method="post" name="MyInfo_form">
            ...
            <table class="MyInfo-table">
                    ...
                    <td>
                        <div class="input-group">
                            <div class="input-with-message">
                                <input type="text" id="u_id" name="u_id" class="input-field input-field-full"
                                       placeholder="아이디" value="${vo.member_id}" disabled/>
                        ...
                        <div class="input-group">
                            <div class="input-with-message">
                                <input type="text" id="u_nickname" name="u_nickname"
                                       class="input-field input-field-full" placeholder="별명"
                                       value="${vo.member_nickname}" disabled/>
                    ...
                    <td>
                        <div class="input-group">
                            <div class="email-group">
                                ...
                                <c:set var="email2"
                                       value="${fn:substring(vo.member_email,emailIndex+1,fn:length(vo.member_email))}"/>
                                <input type="email" id="u_email" name="u_email" class="input-field" placeholder="이메일"
                                       value="${email1}" disabled/>
                                <span class="email-separator">@</span>
                                <input type="email" id="u_email2" name="u_email2" class="input-field"
                                       placeholder="직접 입력" value="${email2}" disabled/>
                                <select id="emailAddr" name="emailAddr" class="email-select"
                                        onchange="changeemail2(this)">
                                    <option value="">직접 입력</option>
                                    <option value="naver.com" <c:if
                                            test="${email2.equals('naver.com')}"> selected</c:if> >naver.com
                                    </option>
                                    <option value="gmail.com" <c:if
                                            test="${email2.equals('gmail.com')}"> selected</c:if> >gmail.com
                                    </option>
                                    <option value="daum.com" <c:if
                                            test="${email2.equals('daum.com')}"> selected</c:if> >daum.com
                                    </option>
                                    <option value="nate.com" <c:if
                                            test="${email2.equals('nate.com')}"> selected</c:if> >nate.com
                                    </option>
                                </select>
                            </div>
                ...
                <tr>
                    <td>경고횟수:</td>
                    <td>
                        <input type="text" id="u_warning" name="u_warning" class="input-field" placeholder="경고횟수"
                               value="현재 경고횟수:${vo.member_warning}" disabled/>
                        <p>변경할 경고횟수:</p>
