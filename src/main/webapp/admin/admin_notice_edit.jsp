    ...
    <div id="post">
        <form id="editform" action="AdminController?type=adminnoticeedit" method="post" enctype="multipart/form-data">
            ...
            <table summary="공지사항 수정">
                ...
                <tr>
                    <th>이름:</th>
                    <td><input type="text" value="관리자" name="member_name" id="member_name" size="12" readonly/></td>
                </tr>
                <tr>
                    <th>내용:</th>
                    <td><textarea name="post_content" cols="50" id="post_content" rows="8">${vo.post_content}</textarea>
                    </td>
                </tr>
                <tr>
                    <th>첨부파일:</th>
                    <td>
                        ...
                        <c:forEach var="f" items="${fileList}">
                            <span class="t_bold">기존파일:${f.file_name_original}</span>
                        </c:forEach>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        ...
                        <input type="button" value="취소"
                               onclick="location.href='AdminController?type=adminnoticeview&post_idx=${param.post_idx}&cPage=${param.cPage}'"/>
