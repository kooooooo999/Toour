        ...
        <ol>
            <li>
                ...
                <select id="contentTypeId" name="contentTypeId">
                    <option value="12" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='12'}">selected</c:if>>관광지
                    </option>
                    <option value="14" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='14'}">selected</c:if>>문화시설
                    </option>
                    <option value="15" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='15'}">selected</c:if>>축제공연/행사
                    </option>
                    <option value="25" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='25'}">selected</c:if>>여행코스
                    </option>
                    <option value="28" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='28'}">selected</c:if>>레포츠
                    </option>
                    <option value="32" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='32'}">selected</c:if>>숙박
                    </option>
                    <option value="38" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='38'}">selected</c:if>>쇼핑
                    </option>
                    <option value="39" class="contentTypeId"
                            <c:if test="${requestcontentTypeId =='39'}">selected</c:if>>음식점
                    </option>
                </select>
            </li>
            <li>
            ...
            <li>
                <select id="sigunguCode" name="sigunguCode">
                    ...
                    <c:forEach var="sigunguCode" items="${requestScope.sigunguCode_list}">
                        <option value="${sigunguCode.code}"
                                <c:if test="${sigunguCode.code ==requestsigunguCode}">selected</c:if> >${sigunguCode.name}</option>
                    </c:forEach>
                </select>
            </li>
            <li>
                <select id="cat1" name="cat1">
                    ...
                    <c:forEach var="cat1" items="${requestScope.cat1_list}">
                        <option value="${cat1.code}"
                                <c:if test="${cat1.code ==requestcat1}">selected</c:if>>${cat1.name}</option>
                    </c:forEach>
                </select>
            </li>
            <li>
                <select id="cat2" name="cat2">
                    ...
                    <c:forEach var="cat2" items="${requestScope.cat2_list}">
                        <option value="${cat2.code}"
                                <c:if test="${cat2.code ==requestcat2}">selected</c:if>>${cat2.name}</option>
                    </c:forEach>
                </select>
            </li>
            <li>
                <select id="cat3" name="cat3">
                    ...
                    <c:forEach var="cat3" items="${requestScope.cat3_list}">
                        <option value="${cat3.code}"
                                <c:if test="${cat3.code ==requestcat3}">selected</c:if>>${cat3.name}</option>
                    </c:forEach>
                </select>
            </li>
            <li>
...
<script>
    ...
    function movePage(npage) {
        ...
        $.ajax({
            ...
            method: "POST",
            data: {
                contentTypeId: contentTypeId, areaCode: areaCode, sigunguCode: sigunguCode,
