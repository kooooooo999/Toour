...
<footer>
    ...
    <div class="footer-sns-intro">
        <div class="container">
            대한민국 toour을 SNS에서 만나보세요!
        </div>
    </div>
    ...
    <div class="container">
        ...
        <nav class="footer-nav">
            <ul>
                <li><a href="#" style="color: #666666">개인정보처리방침</a></li>
                <li><a href="#" style="color: #666666">이용약관</a></li>
                <li><a href="#" style="color: #666666">위치기반서비스 이용약관</a></li>
                <li><a href="#" style="color: #666666">개인위치정보 처리방침</a></li>
                <li><a href="#" style="color: #666666">저작권정책</a></li>
                <li><a href="#" style="color: #666666">고객서비스헌장</a></li>
                <li><a href="#" style="color: #666666">전자우편무단수집거부</a></li>
                <li><a href="#" style="color: #666666">자주 묻는 질문</a></li>
                <li><a href="#" style="color: #666666">찾아오시는 길</a></li>
                <li><a href="#" style="color: #666666">사이트맵</a></li>
            </ul>
        </nav>
        <address class="text-center">
            (우)06235 서울 강남구 테헤란로 132 8층 쌍용교육센터
        </address>
        <p class="text-center contact-info">
            TEL : 0507-1316-4632 사업자등록번호 : 123-45-67890 통신판매신고 : 제2025-쌍용교육-0811호
        </p>
        <p class="copyright">
