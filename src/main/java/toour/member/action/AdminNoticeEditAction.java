...
//        System.out.println("AdminNoticeEditAction 진입");
...
//            System.out.println("GET 요청 (수정 페이지 진입)");
            ...
            viewpath = "admin/admin_notice_edit.jsp";
...
//            System.out.println("POST 요청 (게시글 수정)");
            ...
            try {
                ...
                // DB에 수정 ++
                AdminNoticeDAO.edit(post_idx, post_title, post_content, file_name_stored, file_name_original, ip);
