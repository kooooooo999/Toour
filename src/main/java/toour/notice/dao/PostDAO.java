...
public class PostDAO {
    ...
    public static int getTotalCount(String category_idx){
        ...
        int cnt = ss.selectOne("notice.totalCount",category_idx);
        ss.close();
        return cnt;
    }
    ...
    public static PostVO[] getList(String category_idx, int begin, int end ){
        ...
        SqlSession ss = FactoryService.getFactory().openSession();
        List<PostVO> list = ss.selectList("notice.list", map);
    ...
    public static PostVO getPost(String post_idx){
        SqlSession ss = FactoryService.getFactory().openSession();
        PostVO vo = ss.selectOne("notice.getPost", post_idx);
        ss.close();
        return vo;
    }
    ...
    public static PostVO[] search(String searchType,String searchValue,int begin,int end){
        ...
        SqlSession ss = FactoryService.getFactory().openSession();
        List<PostVO> list = ss.selectList("notice.search",map);
    ...
    public static int hit(String post_idx){
        int cnt = 0;
        SqlSession ss = FactoryService.getFactory().openSession();
        cnt = ss.update("notice.hit", post_idx);
        if(cnt>0)
            ss.commit();
        else
            ss.rollback();
    ...
    public static int edit(String post_idx, String post_title, String post_content,
        ...
        SqlSession ss = FactoryService.getFactory().openSession();
        int cnt = ss.update("notice.edit", map);
        if(cnt > 0)
            ss.commit();
        else ss.rollback();
        ss.close();
    ...
    public static int post_views(String post_idx){
        SqlSession ss = FactoryService.getFactory().openSession();
        int cnt = ss.update("notice.post_views", post_idx);
        if(cnt > 0)
            ss.commit();
        else ss.rollback();
        ss.close();
    ...
    public static String getPostIdx(String post_idx){
        SqlSession ss = FactoryService.getFactory().openSession();
        String postIdx = ss.selectOne("notice.getPostIdx",post_idx);
        ss.close();
        return postIdx;
    ...
    public static MemberVO getPostMemberIdx(String post_idx){
        ...
        SqlSession ss = FactoryService.getFactory().openSession();
        MemberVO postMemberIdx = ss.selectOne("notice.getPostMember",post_idx);
        ss.close();
    ...
    public static int insertComment(String post_idx,String member_idx,String comment_content){
        ...
        SqlSession ss = FactoryService.getFactory().openSession();
        int cnt = ss.insert("notice.insertComment", map);
    ...
    public static CommentVO[] getCommentList(String post_idx){
        ...
        List<CommentVO> list = ss.selectList("notice.getComment",post_idx);
        if(list.size()>0){
